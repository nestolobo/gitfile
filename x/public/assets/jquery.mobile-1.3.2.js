...
$.widget( "mobile.slider", $.mobile.widget, $.extend( {
	...
	_create: function() {
		...
		domSlider.className = ["ui-slider-" + sliderOrientation + " ",selectClass," ui-btn-down-",trackTheme," ui-btn-corner-all", miniClass].join( "" );
		...
		if ( typeof val === "object" ) {
			...
			switch(sliderOrientation)
			{
				case "horizontal":
					...
					break;
				case "vertical":
					percent = ( ( data.pageY - this.slider.offset().top ) / this.slider.height() ) * 100;
					break;
				case "verticalInverted":
					percent = 100 - ( (  data.pageY - this.slider.offset().top  ) / this.slider.height() ) * 100;
					break;
			}	
